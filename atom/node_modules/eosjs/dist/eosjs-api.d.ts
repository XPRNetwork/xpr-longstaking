...
export declare class Api {
     ...
     */
    transact(transaction: Transaction, { broadcast, sign, requiredKeys, compression, blocksBehind, useLastIrreversible, expireSeconds }?: TransactConfig): Promise<TransactResult | PushTransactionArgs>;
